...
//		{
//			for (int j = 0; j < 6; j++)
//				std::cout << output_matrix.data<double>()[matrix_shape[2].getIndex( { 6 * i + j, 0, 0 })] << " ";
//			std::cout << '\n';
//		}
//
...
//		{
//			for (int j = 0; j < 6; j++)
//				std::cout << input_matrix.data<double>()[matrix_shape[1].getIndex( { 6 * i + j, 0, 0 })] << " ";
//			std::cout << '\n';
//		}
//
//		status = cpu_gemmBatched(context, AVOCADO_GEMM_OPERATION_T, AVOCADO_GEMM_OPERATION_N, nullptr, matrix_shape[2], output_matrix,
//				matrix_shape[1], input_matrix, nullptr, matrix_shape[0], weight_matrix);
//		if (status != AVOCADO_STATUS_SUCCESS)
//			return status;
//
//		std::cout << "----------------------------------------------------------\n";
...
//		{
//			for (int j = 0; j < 6; j++)
//				std::cout << weight_matrix.data<double>()[matrix_shape[0].getIndex( { 6 * i + j, 0, 0 })] << " ";
//			std::cout << '\n';
//		}
//
...
//				return explicit_gemm_forward(context, config, alpha1, xDesc, xMem, wDesc, wMem, bDesc, bMem, alpha2, zDesc, zMem, beta, yDesc, yMem,
//						activation, workspaceMem);
//			case AVOCADO_CONVOLUTION_ALGORITHM_WINOGRAD_NON_FUSED:
//				return winograd_nonfused_forward(context, config, alpha1, xDesc, xMem, wDesc, wMem, bDesc, bMem, alpha2, zDesc, zMem, beta, yDesc,
//						yMem, activation, workspaceMem);
//			default:
//				return AVOCADO_STATUS_NOT_SUPPORTED;
//		}
//		return AVOCADO_STATUS_NOT_SUPPORTED;
...
//			case AVOCADO_CONVOLUTION_ALGORITHM_WINOGRAD_NON_FUSED:
//				return winograd_nonfused_backward(context, cfg, alpha, dxDesc, dxMem, wDesc, wMem, beta, dyDesc, dyMem, workspaceMem);
//			default:
//				return AVOCADO_STATUS_NOT_SUPPORTED;
//		}
//		return AVOCADO_STATUS_NOT_SUPPORTED;
