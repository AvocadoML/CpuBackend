...
//		}
//		static inline SIMD<bfloat16> operator+(SIMD<bfloat16> lhs, float rhs) noexcept
//		{
//			return lhs + SIMD<bfloat16>(rhs);
//		}
//		static inline SIMD<bfloat16> operator+(float lhs, SIMD<bfloat16> rhs) noexcept
//		{
//			return SIMD<bfloat16>(lhs) + rhs;
//		}
//		static inline SIMD<bfloat16>& operator+=(SIMD<bfloat16> &lhs, SIMD<bfloat16> rhs) noexcept
//		{
//			lhs = lhs + rhs;
...
//		}
//		static inline SIMD<bfloat16> square(SIMD<bfloat16> x) noexcept
//		{
//			return x * x;
//		}
