...
//				GTEST_SKIP();
//			ReductionTester data(0, GetParam(), { 23, 45 }, AVOCADO_DTYPE_FLOAT16);
...
//				GTEST_SKIP();
//			ReductionTester data(0, GetParam(), { 23, 45 }, AVOCADO_DTYPE_BFLOAT16);
//			float alpha = 1.1f, beta = 0.1f;
...
//		}
		...
		INSTANTIATE_TEST_SUITE_P(TestReduction, TestReduction,
				::testing::Values(AVOCADO_REDUCE_ADD, AVOCADO_REDUCE_MUL, AVOCADO_REDUCE_MIN, AVOCADO_REDUCE_MAX, AVOCADO_REDUCE_AMAX,
						AVOCADO_REDUCE_AVG, AVOCADO_REDUCE_NORM1, AVOCADO_REDUCE_NORM2, AVOCADO_REDUCE_MUL_NO_ZEROS));
