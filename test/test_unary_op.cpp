	...
	namespace backend
	{
		...
		INSTANTIATE_TEST_SUITE_P(TestUnaryOp, TestUnaryOp,
				::testing::Values(AVOCADO_UNARY_OP_ABS, AVOCADO_UNARY_OP_CEIL, AVOCADO_UNARY_OP_COS, AVOCADO_UNARY_OP_EXP, AVOCADO_UNARY_OP_FLOOR,
						AVOCADO_UNARY_OP_LN, AVOCADO_UNARY_OP_NEG, AVOCADO_UNARY_OP_RCP, AVOCADO_UNARY_OP_RSQRT, AVOCADO_UNARY_OP_SIN,
						AVOCADO_UNARY_OP_SQUARE, AVOCADO_UNARY_OP_SQRT, AVOCADO_UNARY_OP_TAN, AVOCADO_UNARY_OP_LOGICAL_NOT));
